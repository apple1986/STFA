...
from networks.unet import UNet, UNet_DS, UNet_URPC, UNet_CCT, UNet_drop,UNet_trans,UNet_fft
...
parser.add_argument('--root_path', type=str,
                    default='/home/data/lxs/SSL1/SSL4MIS-master/SSL4MIS-master/data/ACDC', help='Name of Experiment')
...
parser.add_argument(
    '--cfg', type=str, default="/home/data/lxs/SSL1/SSL4MIS-master/SSL4MIS-master/code/configs/swin_tiny_patch4_window7_224_lite.yaml", help='path to config file', )
parser.add_argument(
    "--opts",
...
def net_factory(net_type="unet", in_chns=1, class_num=3):
    if net_type == "unet":
        ...
        net = XNet(in_channels= in_chns, num_classes= class_num).cuda()
    elif net_type == "unet_fft":
        net = UNet_fft(in_chns=in_chns, class_num=class_num).cuda()
    elif net_type == "unet_trans":
        net = UNet_trans(in_chns=in_chns, class_num=class_num).cuda()
    elif net_type == "unet_drop":
        net = UNet_drop(in_channels=in_chns, num_classes=class_num).cuda()
    elif net_type == "unet_att":
